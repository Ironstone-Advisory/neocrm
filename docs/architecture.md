# Historical implementation scaffold

The original v0.1 scaffold described a TypeScript/Fastify modular monolith and PostgreSQL database as the NeoCRM architecture. That is no longer the authoritative description.
