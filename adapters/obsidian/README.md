...
See the strict [capability manifest](adapter.manifest.json) and shared [adapter catalogue](../_catalog/README.md). Selecting a vault or registering a connection grants no authority; this adapter remains read-only.
