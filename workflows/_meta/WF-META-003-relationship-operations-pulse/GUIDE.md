...
Help an authorized workspace operator complete relationship operations pulse from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized workspace operator asks for relationship operations pulse.
- A relevant event or signal suggests that relationship operations pulse may be useful, subject to human review.

## Produces

- Relationship Operations Pulse result
...
5. **Synthesize relationship operations pulse**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.analytics.read`, `source.data-quality.read`, `source.identity.read`, `source.relationship.read`.
...
Example request: “Help me with relationship operations pulse and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-META-003`. They are placeholders, not executed evidence.
...
Traceability: `FR-TRIGGER-001`, `FR-METRIC-001`, `FR-SUPERVISOR-001`, `EXP-011`, `EXP-012`, `EXP-018`, `EXP-021`, `EXP-024`.
...
- [EXP-012](../../../experiments/EXP-012-temporal-relationship-analysis/spec.md)
