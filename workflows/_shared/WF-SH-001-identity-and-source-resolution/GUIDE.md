...
Give registered workflows a reusable, policy-bound identity and source resolution routine without creating a second business-facing workflow.

## Use when

- A registered parent workflow requests the bounded identity and source resolution routine.

## Produces

- Identity and Source Resolution result
...
5. **Synthesize identity and source resolution**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.identity.read`, `source.data-quality.read`.
...
Example request: “Call WF-SH-001 for identity and source resolution within the parent workflow's scope.”

Planned fixtures: `PLANNED-FIXTURE-WF-SH-001`. They are placeholders, not executed evidence.
...
Traceability: `SAFE-IDENT-001`, `FR-DATAQUALITY-001`, `EXP-006`, `EXP-017`.
...
- [SAFE-IDENT-001](../../../spec/requirements/safety.md)
