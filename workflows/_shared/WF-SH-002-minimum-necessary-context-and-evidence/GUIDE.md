...
Give registered workflows a reusable, policy-bound minimum necessary context and evidence routine without creating a second business-facing workflow.

## Use when

- A registered parent workflow requests the bounded minimum necessary context and evidence routine.

## Produces

- Minimum Necessary Context and Evidence result
...
5. **Synthesize minimum necessary context and evidence**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.relationship.read`, `source.knowledge.read`.
...
Example request: “Call WF-SH-002 for minimum necessary context and evidence within the parent workflow's scope.”

Planned fixtures: `PLANNED-FIXTURE-WF-SH-002`. They are placeholders, not executed evidence.
...
Traceability: `FR-CTX-001`, `SAFE-DATA-001`, `EXP-001`, `EXP-007`.
...
- [SAFE-DATA-001](../../../spec/requirements/safety.md)
