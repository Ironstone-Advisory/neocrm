...
Give registered workflows a reusable, policy-bound typed handoff and seam recovery routine without creating a second business-facing workflow.

## Use when

- A registered parent workflow requests the bounded typed handoff and seam recovery routine.

## Produces

- Typed Handoff and Seam Recovery result
...
5. **Synthesize typed handoff and seam recovery**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.relationship.read`, `source.activity.read`.
...
Example request: “Call WF-SH-007 for typed handoff and seam recovery within the parent workflow's scope.”

Planned fixtures: `PLANNED-FIXTURE-WF-SH-007`. They are placeholders, not executed evidence.
...
Traceability: `FR-HANDOFF-001`, `EXP-020`, `EXP-021`, `EXP-024`.
