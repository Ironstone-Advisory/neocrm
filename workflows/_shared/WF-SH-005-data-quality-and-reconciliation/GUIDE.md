...
Give registered workflows a reusable, policy-bound data quality and reconciliation routine without creating a second business-facing workflow.

## Use when

- A registered parent workflow requests the bounded data quality and reconciliation routine.

## Produces

- Data Quality and Reconciliation result
...
5. **Synthesize data quality and reconciliation**
...
Example request: “Call WF-SH-005 for data quality and reconciliation within the parent workflow's scope.”

Planned fixtures: `PLANNED-FIXTURE-WF-SH-005`. They are placeholders, not executed evidence.
...
Traceability: `FR-ARCHIVE-001`, `FR-DATAQUALITY-001`, `EXP-017`.
...
- [FR-ARCHIVE-001](../../../spec/requirements/approved-portfolio.md)
