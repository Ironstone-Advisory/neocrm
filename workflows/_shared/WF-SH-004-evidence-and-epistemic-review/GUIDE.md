...
Give registered workflows a reusable, policy-bound evidence and epistemic review routine without creating a second business-facing workflow.

## Use when

- A registered parent workflow requests the bounded evidence and epistemic review routine.

## Produces

- Evidence and Epistemic Review result
...
5. **Synthesize evidence and epistemic review**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.knowledge.read`, `source.conversation.read`.
...
Example request: “Call WF-SH-004 for evidence and epistemic review within the parent workflow's scope.”

Planned fixtures: `PLANNED-FIXTURE-WF-SH-004`. They are placeholders, not executed evidence.
...
Traceability: `FR-CONVINT-001`, `EXP-007`, `EXP-013`.
...
- [EXP-007](../../../experiments/EXP-007-epistemics-and-provenance/spec.md)
