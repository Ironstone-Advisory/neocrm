...
Help an authorized marketer or growth leader complete intent signal and account activation from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for intent signal and account activation.
- A relevant event or signal suggests that intent signal and account activation may be useful, subject to human review.

## Produces

- Intent Signal and Account Activation result
...
5. **Synthesize intent signal and account activation**
...
Example request: “Help me with intent signal and account activation and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-009`. They are placeholders, not executed evidence.
...
Traceability: `FR-INTENT-001`, `EXP-020`.
...
- [FR-INTENT-001](../../../spec/requirements/approved-portfolio.md)
