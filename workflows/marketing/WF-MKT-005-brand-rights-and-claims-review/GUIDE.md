...
Help an authorized marketer or growth leader complete brand rights and claims review from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for brand rights and claims review.
- A relevant event or signal suggests that brand rights and claims review may be useful, subject to human review.

## Produces

- Brand Rights and Claims Review result
...
5. **Synthesize brand rights and claims review**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.analytics.read`, `source.consent.read`, `source.content.read`, `source.engagement.read`, `source.identity.read`.
...
Example request: “Help me with brand rights and claims review and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-005`. They are placeholders, not executed evidence.
