...
Help an authorized marketer or growth leader complete campaign brief and goal plan from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for campaign brief and goal plan.
- A relevant event or signal suggests that campaign brief and goal plan may be useful, subject to human review.

## Produces

- Campaign Brief and Goal Plan result
...
5. **Synthesize campaign brief and goal plan**
...
Example request: “Help me with campaign brief and goal plan and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-002`. They are placeholders, not executed evidence.
