...
Help an authorized marketer or growth leader complete inbound qualification booking and handoff from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for inbound qualification booking and handoff.
- A relevant event or signal suggests that inbound qualification booking and handoff may be useful, subject to human review.

## Produces

- Inbound Qualification Booking and Handoff result
...
5. **Synthesize inbound qualification booking and handoff**
...
Capability intents: `source.analytics.read`, `source.consent.read`, `source.engagement.read`, `source.identity.read`, `source.time.read`.
...
Example request: “Help me with inbound qualification booking and handoff and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-010`. They are placeholders, not executed evidence.
...
Traceability: `FR-INBOUND-001`, `FR-HANDOFF-001`, `EXP-020`.
...
- [FR-INBOUND-001](../../../spec/requirements/approved-portfolio.md)
- [FR-HANDOFF-001](../../../spec/requirements/functional.md)
