...
Help an authorized marketer or growth leader complete campaign performance and attribution from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for campaign performance and attribution.
- A relevant event or signal suggests that campaign performance and attribution may be useful, subject to human review.

## Produces

- Campaign Performance and Attribution result
...
5. **Synthesize campaign performance and attribution**
...
Example request: “Help me with campaign performance and attribution and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-012`. They are placeholders, not executed evidence.
...
Traceability: `FR-METRIC-001`, `SAFE-ATTRIB-001`, `EXP-020`.
