...
Help an authorized marketer or growth leader complete audience and contact eligibility from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for audience and contact eligibility.
- A relevant event or signal suggests that audience and contact eligibility may be useful, subject to human review.

## Produces

- Audience and Contact Eligibility result
...
5. **Synthesize audience and contact eligibility**
...
Example request: “Help me with audience and contact eligibility and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-001`. They are placeholders, not executed evidence.
...
Traceability: `FR-CAMPAIGN-001`, `FR-CONSENT-001`, `EXP-020`.
...
- [FR-CAMPAIGN-001](../../../spec/requirements/functional.md)
