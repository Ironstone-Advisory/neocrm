...
Help an authorized marketer or growth leader complete reputation and voice of customer from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for reputation and voice of customer.
- A relevant event or signal suggests that reputation and voice of customer may be useful, subject to human review.

## Produces

- Reputation and Voice of Customer result
...
5. **Synthesize reputation and voice of customer**
...
Example request: “Help me with reputation and voice of customer and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-014`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-SUCCESS-001`, `EXP-021`, `EXP-022`.
