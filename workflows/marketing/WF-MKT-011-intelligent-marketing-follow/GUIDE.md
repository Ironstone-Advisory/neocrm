...
Help an authorized marketer or growth leader complete intelligent marketing follow from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for intelligent marketing follow.
- A relevant event or signal suggests that intelligent marketing follow may be useful, subject to human review.

## Produces

- Intelligent Marketing Follow result
...
5. **Synthesize intelligent marketing follow**
...
Capability intents: `source.analytics.read`, `source.consent.read`, `source.conversation.read`, `source.engagement.read`, `source.identity.read`.
...
Example request: “Help me with intelligent marketing follow and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-011`. They are placeholders, not executed evidence.
...
Traceability: `FR-FOLLOWUP-001`, `FR-JOURNEY-002`, `EXP-014`, `EXP-020`.
