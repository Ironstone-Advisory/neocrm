...
Help an authorized marketer or growth leader complete content and asset variant drafting from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for content and asset variant drafting.
- A relevant event or signal suggests that content and asset variant drafting may be useful, subject to human review.

## Produces

- Content and Asset Variant Drafting result
...
5. **Synthesize content and asset variant drafting**
...
Example request: “Help me with content and asset variant drafting and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-004`. They are placeholders, not executed evidence.
