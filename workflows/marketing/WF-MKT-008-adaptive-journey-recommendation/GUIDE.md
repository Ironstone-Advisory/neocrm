...
Help an authorized marketer or growth leader complete adaptive journey recommendation from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for adaptive journey recommendation.
- A relevant event or signal suggests that adaptive journey recommendation may be useful, subject to human review.

## Produces

- Adaptive Journey Recommendation result
...
5. **Synthesize adaptive journey recommendation**
...
Example request: “Help me with adaptive journey recommendation and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-008`. They are placeholders, not executed evidence.
...
Traceability: `FR-JOURNEY-002`, `SAFE-CONTACT-001`, `EXP-020`.
...
- [FR-JOURNEY-002](../../../spec/requirements/approved-portfolio.md)
