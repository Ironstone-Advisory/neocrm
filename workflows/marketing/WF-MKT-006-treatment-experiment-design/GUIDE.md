...
Help an authorized marketer or growth leader complete treatment experiment design from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized marketer or growth leader asks for treatment experiment design.
- A relevant event or signal suggests that treatment experiment design may be useful, subject to human review.

## Produces

- Treatment Experiment Design result
...
5. **Synthesize treatment experiment design**
...
Example request: “Help me with treatment experiment design and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-MKT-006`. They are placeholders, not executed evidence.
