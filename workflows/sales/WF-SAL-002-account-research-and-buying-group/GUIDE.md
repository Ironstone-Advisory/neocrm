...
Help an authorized seller or revenue leader complete account research and buying group from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for account research and buying group.
- A relevant event or signal suggests that account research and buying group may be useful, subject to human review.

## Produces

- Account Research and Buying Group result
...
5. **Synthesize account research and buying group**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.commercial.read`, `source.identity.read`, `source.knowledge.read`, `source.relationship.read`.
...
Example request: “Help me with account research and buying group and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-002`. They are placeholders, not executed evidence.
...
Traceability: `FR-BUYINGGROUP-001`, `EXP-008`, `EXP-019`.
...
- [FR-BUYINGGROUP-001](../../../spec/requirements/approved-portfolio.md)
- [EXP-008](../../../experiments/EXP-008-relationship-graph-recommendations/spec.md)
