...
Help an authorized seller or revenue leader complete governed crm activity and opportunity update from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for governed crm activity and opportunity update.
- A relevant event or signal suggests that governed crm activity and opportunity update may be useful, subject to human review.

## Produces

- Governed CRM Activity and Opportunity Update result
...
5. **Synthesize governed crm activity and opportunity update**
...
Example request: “Help me with governed crm activity and opportunity update and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-012`. They are placeholders, not executed evidence.
...
Traceability: `FR-ACT-001`, `FR-GRANT-001`, `FR-DELETE-001`, `EXP-015`.
