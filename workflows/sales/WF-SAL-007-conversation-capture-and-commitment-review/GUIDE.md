...
Help an authorized seller or revenue leader complete conversation capture and commitment review from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for conversation capture and commitment review.
- A relevant event or signal suggests that conversation capture and commitment review may be useful, subject to human review.

## Produces

- Conversation Capture and Commitment Review result
...
5. **Synthesize conversation capture and commitment review**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.commercial.read`, `source.conversation.read`, `source.identity.read`, `source.relationship.read`, `source.time.read`.
...
Example request: “Help me with conversation capture and commitment review and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-007`. They are placeholders, not executed evidence.
...
Traceability: `FR-CONVINT-001`, `EXP-009`, `EXP-013`.
...
- [FR-CONVINT-001](../../../spec/requirements/approved-portfolio.md)
- [EXP-009](../../../experiments/EXP-009-activity-message-conversation/spec.md)
- [EXP-013](../../../experiments/EXP-013-conversation-intelligence/spec.md)
