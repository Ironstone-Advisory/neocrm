...
Help an authorized seller or revenue leader complete pipeline review and hygiene from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for pipeline review and hygiene.
- A relevant event or signal suggests that pipeline review and hygiene may be useful, subject to human review.

## Produces

- Pipeline Review and Hygiene result
...
5. **Synthesize pipeline review and hygiene**
...
Example request: “Help me with pipeline review and hygiene and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-006`. They are placeholders, not executed evidence.
...
Traceability: `FR-DATAQUALITY-001`, `EXP-015`, `EXP-017`, `EXP-018`.
