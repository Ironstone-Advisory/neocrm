...
Help an authorized seller or revenue leader complete account and mutual action plan from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for account and mutual action plan.
- A relevant event or signal suggests that account and mutual action plan may be useful, subject to human review.

## Produces

- Account and Mutual Action Plan result
...
5. **Synthesize account and mutual action plan**
...
Example request: “Help me with account and mutual action plan and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-010`. They are placeholders, not executed evidence.
...
Traceability: `FR-ACCOUNTPLAN-001`, `EXP-019`.
...
- [FR-ACCOUNTPLAN-001](../../../spec/requirements/approved-portfolio.md)
