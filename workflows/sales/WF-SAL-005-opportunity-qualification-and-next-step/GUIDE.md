...
Help an authorized seller or revenue leader complete opportunity qualification and next step from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for opportunity qualification and next step.
- A relevant event or signal suggests that opportunity qualification and next step may be useful, subject to human review.

## Produces

- Opportunity Qualification and Next Step result
...
5. **Synthesize opportunity qualification and next step**
...
Example request: “Help me with opportunity qualification and next step and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-005`. They are placeholders, not executed evidence.
...
Traceability: `FR-QUALIFY-001`, `EXP-018`, `EXP-019`.
