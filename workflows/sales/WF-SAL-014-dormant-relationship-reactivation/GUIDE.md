...
Help an authorized seller or revenue leader complete dormant relationship reactivation from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for dormant relationship reactivation.
- A relevant event or signal suggests that dormant relationship reactivation may be useful, subject to human review.

## Produces

- Dormant Relationship Reactivation result
...
5. **Synthesize dormant relationship reactivation**
...
Capability intents: `source.activity.read`, `source.commercial.read`, `source.consent.read`, `source.identity.read`, `source.relationship.read`.
...
Example request: “Help me with dormant relationship reactivation and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-014`. They are placeholders, not executed evidence.
...
Traceability: `FR-FOLLOWUP-001`, `FR-SEQUENCE-001`, `SAFE-CONTACT-001`, `EXP-014`, `EXP-019`, `EXP-020`.
