...
Help an authorized seller or revenue leader complete speed to lead and booking from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for speed to lead and booking.
- A relevant event or signal suggests that speed to lead and booking may be useful, subject to human review.

## Produces

- Speed to Lead and Booking result
...
5. **Synthesize speed to lead and booking**
...
Capability intents: `source.activity.read`, `source.commercial.read`, `source.identity.read`, `source.relationship.read`, `source.time.read`.
...
Example request: “Help me with speed to lead and booking and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-004`. They are placeholders, not executed evidence.
...
Traceability: `FR-INBOUND-001`, `SAFE-CONTACT-001`, `EXP-020`.
