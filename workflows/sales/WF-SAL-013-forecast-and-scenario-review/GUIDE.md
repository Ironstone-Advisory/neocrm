...
Help an authorized seller or revenue leader complete forecast and scenario review from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for forecast and scenario review.
- A relevant event or signal suggests that forecast and scenario review may be useful, subject to human review.

## Produces

- Forecast and Scenario Review result
...
5. **Synthesize forecast and scenario review**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.analytics.read`, `source.commercial.read`, `source.identity.read`, `source.relationship.read`.
...
Example request: “Help me with forecast and scenario review and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-013`. They are placeholders, not executed evidence.
...
Traceability: `FR-FORECAST-001`, `FR-METRIC-001`, `EXP-018`.
...
- [FR-FORECAST-001](../../../spec/requirements/approved-portfolio.md)
