...
Help an authorized seller or revenue leader complete outreach sequence and enrollment from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for outreach sequence and enrollment.
- A relevant event or signal suggests that outreach sequence and enrollment may be useful, subject to human review.

## Produces

- Outreach Sequence and Enrollment result
...
5. **Synthesize outreach sequence and enrollment**
...
Capability intents: `source.activity.read`, `source.commercial.read`, `source.consent.read`, `source.conversation.read`, `source.identity.read`, `source.relationship.read`.
...
Example request: “Help me with outreach sequence and enrollment and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-009`. They are placeholders, not executed evidence.
...
Traceability: `FR-SEQUENCE-001`, `EXP-019`.
...
- [FR-SEQUENCE-001](../../../spec/requirements/approved-portfolio.md)
