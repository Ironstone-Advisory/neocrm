...
Help an authorized seller or revenue leader complete proposal and rfp response from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for proposal and rfp response.
- A relevant event or signal suggests that proposal and rfp response may be useful, subject to human review.

## Produces

- Proposal and RFP Response result
...
5. **Synthesize proposal and rfp response**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.commercial.read`, `source.conversation.read`, `source.identity.read`, `source.knowledge.read`, `source.relationship.read`.
...
Example request: “Help me with proposal and rfp response and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-011`. They are placeholders, not executed evidence.
...
Traceability: `FR-CONTENT-001`, `EXP-022`, `D06`, `D45`.
...
- [Portfolio decisions D06, D45](../../../spec/product/decision-register.md)
