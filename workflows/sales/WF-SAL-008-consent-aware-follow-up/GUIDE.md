...
Help an authorized seller or revenue leader complete consent aware follow up from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized seller or revenue leader asks for consent aware follow up.
- A relevant event or signal suggests that consent aware follow up may be useful, subject to human review.

## Produces

- Consent Aware Follow Up result
...
5. **Synthesize consent aware follow up**
...
Example request: “Help me with consent aware follow up and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SAL-008`. They are placeholders, not executed evidence.
...
Traceability: `FR-FOLLOWUP-001`, `SAFE-CONTACT-001`, `EXP-014`.
