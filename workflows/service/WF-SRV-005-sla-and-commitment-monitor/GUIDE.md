...
Help an authorized service or customer-success teammate complete sla and commitment monitor from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for sla and commitment monitor.
- A relevant event or signal suggests that sla and commitment monitor may be useful, subject to human review.

## Produces

- SLA and Commitment Monitor result
...
5. **Synthesize sla and commitment monitor**
...
Capability intents: `source.activity.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`, `source.time.read`.
...
Example request: “Help me with sla and commitment monitor and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-005`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-TRIGGER-001`, `EXP-011`, `EXP-021`.
