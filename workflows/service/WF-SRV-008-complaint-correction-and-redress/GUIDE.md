...
Help an authorized service or customer-success teammate complete complaint correction and redress from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for complaint correction and redress.
- A relevant event or signal suggests that complaint correction and redress may be useful, subject to human review.

## Produces

- Complaint Correction and Redress result
...
5. **Synthesize complaint correction and redress**
...
Capability intents: `source.activity.read`, `source.data-quality.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`.
...
Example request: “Help me with complaint correction and redress and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-008`. They are placeholders, not executed evidence.
...
Traceability: `SAFE-HARM-001`, `FR-DATAQUALITY-001`, `EXP-017`, `EXP-021`.
...
- [FR-DATAQUALITY-001](../../../spec/requirements/approved-portfolio.md)
