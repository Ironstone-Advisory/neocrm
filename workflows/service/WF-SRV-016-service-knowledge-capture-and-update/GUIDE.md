...
Help an authorized service or customer-success teammate complete service knowledge capture and update from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for service knowledge capture and update.
- A relevant event or signal suggests that service knowledge capture and update may be useful, subject to human review.

## Produces

- Service Knowledge Capture and Update result
...
5. **Synthesize service knowledge capture and update**
...
Example request: “Help me with service knowledge capture and update and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-016`. They are placeholders, not executed evidence.
...
Traceability: `FR-CONTENT-001`, `SAFE-MEM-001`, `EXP-016`, `EXP-021`, `EXP-022`.
...
- [SAFE-MEM-001](../../../spec/requirements/safety.md)
