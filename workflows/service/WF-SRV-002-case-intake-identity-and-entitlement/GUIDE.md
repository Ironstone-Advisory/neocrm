...
Help an authorized service or customer-success teammate complete case intake identity and entitlement from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for case intake identity and entitlement.
- A relevant event or signal suggests that case intake identity and entitlement may be useful, subject to human review.

## Produces

- Case Intake Identity and Entitlement result
...
5. **Synthesize case intake identity and entitlement**
...
Example request: “Help me with case intake identity and entitlement and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-002`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-HANDOFF-001`, `EXP-021`.
