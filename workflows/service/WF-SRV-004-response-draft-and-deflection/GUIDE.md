...
Help an authorized service or customer-success teammate complete response draft and deflection from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for response draft and deflection.
- A relevant event or signal suggests that response draft and deflection may be useful, subject to human review.

## Produces

- Response Draft and Deflection result
...
5. **Synthesize response draft and deflection**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.conversation.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`.
...
Example request: “Help me with response draft and deflection and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-004`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-FOLLOWUP-001`, `EXP-014`, `EXP-021`.
...
- [FR-FOLLOWUP-001](../../../spec/requirements/approved-portfolio.md)
