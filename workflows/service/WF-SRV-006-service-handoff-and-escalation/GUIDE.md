...
Help an authorized service or customer-success teammate complete service handoff and escalation from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for service handoff and escalation.
- A relevant event or signal suggests that service handoff and escalation may be useful, subject to human review.

## Produces

- Service Handoff and Escalation result
...
5. **Synthesize service handoff and escalation**
...
Example request: “Help me with service handoff and escalation and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-006`. They are placeholders, not executed evidence.
...
Traceability: `FR-HANDOFF-001`, `FR-SUPERVISOR-001`, `EXP-021`, `EXP-024`.
...
- [FR-SUPERVISOR-001](../../../spec/requirements/approved-portfolio.md)
