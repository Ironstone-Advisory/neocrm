...
Help an authorized service or customer-success teammate complete success plan and outcome review from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for success plan and outcome review.
- A relevant event or signal suggests that success plan and outcome review may be useful, subject to human review.

## Produces

- Success Plan and Outcome Review result
...
5. **Synthesize success plan and outcome review**
...
Example request: “Help me with success plan and outcome review and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-010`. They are placeholders, not executed evidence.
...
Traceability: `FR-SUCCESS-001`, `FR-OUT-001`, `EXP-021`.
