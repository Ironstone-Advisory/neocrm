...
Help an authorized service or customer-success teammate complete customer onboarding and adoption from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for customer onboarding and adoption.
- A relevant event or signal suggests that customer onboarding and adoption may be useful, subject to human review.

## Produces

- Customer Onboarding and Adoption result
...
5. **Synthesize customer onboarding and adoption**
...
Capability intents: `source.activity.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`, `source.usage.read`.
...
Example request: “Help me with customer onboarding and adoption and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-011`. They are placeholders, not executed evidence.
...
Traceability: `FR-SUCCESS-001`, `FR-EDU-001`, `EXP-021`, `EXP-023`.
