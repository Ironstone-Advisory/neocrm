...
Help an authorized service or customer-success teammate complete customer health review from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for customer health review.
- A relevant event or signal suggests that customer health review may be useful, subject to human review.

## Produces

- Customer Health Review result
...
5. **Synthesize customer health review**
6. **Escalate insufficient or conflicting evidence**
7. **Review result and next decision**

## Sources and fallback

Capability intents: `source.activity.read`, `source.analytics.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`.
...
Example request: “Help me with customer health review and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-009`. They are placeholders, not executed evidence.
...
Traceability: `FR-SUCCESS-001`, `FR-INSIGHT-001`, `EXP-021`.
...
- [FR-INSIGHT-001](../../../spec/requirements/functional.md)
