...
Help an authorized service or customer-success teammate complete case triage and priority from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for case triage and priority.
- A relevant event or signal suggests that case triage and priority may be useful, subject to human review.

## Produces

- Case Triage and Priority result
...
5. **Synthesize case triage and priority**
...
Example request: “Help me with case triage and priority and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-003`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-SUPERVISOR-001`, `EXP-021`, `EXP-024`.
