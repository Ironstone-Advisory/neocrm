...
Help an authorized service or customer-success teammate complete usage and entitlement anomaly from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for usage and entitlement anomaly.
- A relevant event or signal suggests that usage and entitlement anomaly may be useful, subject to human review.

## Produces

- Usage and Entitlement Anomaly result
...
5. **Synthesize usage and entitlement anomaly**
...
Capability intents: `source.activity.read`, `source.analytics.read`, `source.entitlement.read`, `source.identity.read`, `source.relationship.read`, `source.service.read`, `source.usage.read`.
...
Example request: “Help me with usage and entitlement anomaly and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-012`. They are placeholders, not executed evidence.
...
Traceability: `FR-SUCCESS-001`, `FR-METRIC-001`, `EXP-021`.
