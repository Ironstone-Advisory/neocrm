...
Help an authorized service or customer-success teammate complete resolution verification and closure from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for resolution verification and closure.
- A relevant event or signal suggests that resolution verification and closure may be useful, subject to human review.

## Produces

- Resolution Verification and Closure result
...
5. **Synthesize resolution verification and closure**
...
Example request: “Help me with resolution verification and closure and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-007`. They are placeholders, not executed evidence.
...
Traceability: `FR-SERVICE-001`, `FR-OUT-001`, `EXP-021`.
