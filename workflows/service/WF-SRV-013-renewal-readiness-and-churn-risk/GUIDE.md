...
Help an authorized service or customer-success teammate complete renewal readiness and churn risk from relationship evidence while keeping source gaps, uncertainty and authority visible.

## Use when

- An authorized service or customer-success teammate asks for renewal readiness and churn risk.
- A relevant event or signal suggests that renewal readiness and churn risk may be useful, subject to human review.

## Produces

- Renewal Readiness and Churn Risk result
...
5. **Synthesize renewal readiness and churn risk**
...
Example request: “Help me with renewal readiness and churn risk and show the evidence, gaps and decisions I need to make.”

Planned fixtures: `PLANNED-FIXTURE-WF-SRV-013`. They are placeholders, not executed evidence.
