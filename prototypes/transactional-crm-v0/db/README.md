# Archived relational schema probe

`migrations/0001_initial.sql` is a preserved exploratory PostgreSQL mapping from the initial repository scaffold. It is not NeoCRM's canonical ontology, active Hybrid Data Storage design, or a production migration.
